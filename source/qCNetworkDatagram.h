...
#ifndef __QCNETWORKDATAGRAM_H__
#define __QCNETWORKDATAGRAM_H__

#include	"qTypes.h"
#include	"qCNetwork.h"

class qCNetworkDatagram
{
public:

	// Constructor / Destructor
	explicit qCNetworkDatagram	( void )	{ }	/**< Constructor */
			~qCNetworkDatagram	( void )	{ }	/**< Destructor */
...
//////////////////////////////////////////////////////////////////////////
	...
	static void			SetReturnOnError		( const qBool ReturnOnError );
	static void			SetReturnReason			( const qChar* pReturnReason );
	static qChar*		GetReturnReason			( void );
