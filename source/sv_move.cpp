...
void SV_NewChaseDir (edict_t *actor, edict_t *enemy, float dist)
{
	...
	olddir = qCMath::AngleMod( (int)(actor->v.ideal_yaw/45)*45 );
	turnaround = qCMath::AngleMod(olddir - 180);
